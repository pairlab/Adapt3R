...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene1(InitialSceneTemplates):
    def __init__(self):
    ...
    def define_regions(self):
        ...
        self.regions.update(
            self.get_region_dict(
                ...
                region_name="macaroni_and_cheese_init_region",
                target_name=self.workspace_name,
                region_half_len=0.1,
            )
        )
        ...
        self.regions.update(
            self.get_region_dict(
                ...
                region_name="cookies_init_region",
                target_name=self.workspace_name,
                region_half_len=0.1,
            )
        )
        ...
        self.regions.update(
            self.get_region_dict(
                region_centroid_xy=[-0.30, -0.1],
                region_name="bbq_sauce_init_region",
                target_name=self.workspace_name,
                region_half_len=0.1,
            )
        )
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene2(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene3(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene4(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene5(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene6(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene7(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene8(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene9(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="kitchen_distractor")
class KitchenDistractorScene10(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="living_room_distractor")
class LivingRoomDistractorScene1(InitialSceneTemplates):
    def __init__(self):
    ...
    def define_regions(self):
        ...
        self.regions.update(
            self.get_region_dict(
                region_centroid_xy=[-0.275, -0.275],
                region_name="macaroni_and_cheese_init_region",
                target_name=self.workspace_name,
                region_half_len=0.05,
            )
...
@register_mu(scene_type="living_room_distractor")
class LivingRoomDistractorScene2(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="living_room_distractor")
class LivingRoomDistractorScene3(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="living_room_distractor")
class LivingRoomDistractorScene4(InitialSceneTemplates):
    def __init__(self):
    ...
    def define_regions(self):
        ...
        self.regions.update(
            self.get_region_dict(
                ...
                region_name="new_salad_dressing_init_region",
                target_name=self.workspace_name,
                region_half_len=0.025,
            )
        )
        ...
        self.regions.update(
            self.get_region_dict(
                region_centroid_xy=[0.025, 0.025],
                region_name="cookies_init_region",
                target_name=self.workspace_name,
                region_half_len=0.025,
            )
    ...
    def init_states(self):
        states = [
            ...
            (
                ...
                "living_room_table_new_salad_dressing_init_region",
            ),
            ("On", "wooden_tray_1", "living_room_table_wooden_tray_init_region"),
            # Added stuff here:
            ("On", "macaroni_and_cheese_1", "living_room_table_macaroni_and_cheese_init_region"),
...
@register_mu(scene_type="living_room_distractor")
class LivingRoomDistractorScene5(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="living_room_distractor")
class LivingRoomDistractorScene6(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="study_distractor")
class StudyDistractorScene1(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="study_distractor")
class StudyDistractorScene2(InitialSceneTemplates):
    def __init__(self):
        fixture_num_info = {
            "study_table": 1,
            "desk_caddy": 1,
...
@register_mu(scene_type="study_distractor")
class StudyDistractorScene3(InitialSceneTemplates):
    def __init__(self):
        fixture_num_info = {
            "study_table": 1,
            "desk_caddy": 1,
...
@register_mu(scene_type="study_distractor")
class StudyDistractorScene4(InitialSceneTemplates):
    def __init__(self):
        fixture_num_info = {
            "study_table": 1,
            "wooden_two_layer_shelf": 1,
    ...
    def define_regions(self):
        ...
        self.regions.update(
            self.get_region_dict(
                region_centroid_xy=[0.175, -0.175],
                region_name="bbq_sauce_init_region",
                target_name=self.workspace_name,
                region_half_len=0.025,
            )
